//Sun May 04 2025 14:58:14 GMT+0000 (Coordinated Universal Time)
...
class Common {
  ...
  ["formatTime"](IIIliI, II1i1Ill = Date.now()) {
    ...
    Object.keys(II1i11ii).forEach(lilillII => {
    ...
    try {
      {
        ...
        if (lIil1Ili?.["hostname"]) {
          ...
          (lIil1Ili?.["username"] || lIil1Ili?.["password"]) && (Iilii11i.auth = {
  ...
  ["_getProxyAddressWithConfig"](il1iII = null) {
    try {
      ...
      let liiIi1Ii = "";
      I1llIIIl.auth && (liiIi1Ii = (I1llIIIl.auth?.["username"] || "") + ":" + (I1llIIIl.auth?.["password"] || "") + "@");
      return I1llIIIl.protocol + "://" + liiIi1Ii + I1llIIIl.host + ":" + I1llIIIl.port;
    } catch {
  ...
  ["_genHttpsAgentWithProxyConfig"](ill1IIi) {
    try {
      ...
      ill1IIi?.["auth"] && (liIllIi1 += (ill1IIi.auth?.["username"] || "") + ":" + (ill1IIi.auth?.["password"] || "") + "@");
      liIllIi1 += ill1IIi?.["host"] + ":" + (ill1IIi?.["port"] || "8080");
      return new this._HttpsProxyAgent(liIllIi1);
    } catch (IIi11ll1) {
  ...
  ["genUA"](Ii11I11I = "", IlIIl1I1 = "jd") {
    ...
    switch (ilili1iI) {
      ...
      default:
        ...
        iIllll1I = [I1lI1lIi, "iPhone", lliIllIl, "", "rn/" + this.genUuid(), "M/5.0", "appBuild/" + illill1i, "jdSupportDarkMode/0", "ef/1", liIi1111 ? "ep/" + encodeURIComponent(liIi1111) : "", "Mozilla/5.0 (" + I11i1lI + ") AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148", "supportJDSHWK/1", ""];
        l1IiIiI1 = ";";
        break;
    }
  ...
  ["getJEH"](IIIlIiIi = "") {
    !IIIlIiIi && (IIIlIiIi = "JD4iPhone/" + this.getLatestAppBuildVersion() + " (iPhone; iOS " + this.getLatestIOSVersion() + "; Scale/3.00)");
  ...
  async ["joinShopMember"](liiiiil, IIlllIi1 = this._Cookie, Ii1iI1i = "") {
    ...
    try {
      ...
      if (iiIiii?.["success"] === true) {
        ...
        if (iiIiii?.["message"]) {
          console.log("🚫 加入店铺会员失败 ➜ " + iiIiii.message);
          return false;
        } else {
...
class Base64Algorithm {
  ...
  static ["decode"](IlIi1ll1, i11iIIll = "KLMNOPQRSTABCDEFGHIJUVWXYZabcdopqrstuvwxefghijklmnyz0123456789+/") {
    ...
    i1l1Ii1i = this._utf8Decode(i1l1Ii1i);
    return i1l1Ii1i;
  }
}
